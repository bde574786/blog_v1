        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              <li class="nav-item">
                <a href="/story/home" class="dropdown-item text-primary"> <i class="fas fa-cloud"></i>&nbsp;&nbsp;SHOW STORY </a>
              </li>
              <li class="nav-item">
                <a href="/story/upload" class="dropdown-item text-primary"> <i class="fas fa-file"></i>&nbsp;&nbsp;UPLOAD</a>
              </li>
            </ul>
          </li>
        </ul>
