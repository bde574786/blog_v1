...
//	@ResponseBody
	public String kakaoCallback(@RequestParam String code) {
		...
		params.add("client_id", "e5904cba56818ec84f52222aff569869");
        ...
        // 소셜 로그인 처리 -->
        // 사용자가 로그인 했을 경우 최초 사용자라면 -> 회원가입 처리한다.
        // -> 회원가입 처리한다.
        // -> 한 번이라도 가입 진행이 된 사용자면 로그인 처리를 해 주면 된다.
        // -> 만약 회원가입시 필요한 벙보가 더 있어야 된다면 추가로 사용자한테 정보를 받아서 가입 진행처리를
        // 해야한다.
        ...
        System.out.println("블로그에서 사용될 유저 네임" + account.getEmail()+ "_" + kakaoProfileResponse.getBody().getId());
